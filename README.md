...
*The plots in this section are generated by the test scripts,i.e.,script_test_fcn_fcnname, for these core functions.*
...
- fcn_GPS_lla2xyz (Standalone,vectorized)
- lla2ecef (MATLAB built-in, ,vectorized)
...
- gpsObj.WGSLLA2ENU (GPS class,vectorized)
- fcn_GPS_lla2enu (Standalone,vectorized)
- lla2enu (MATLAB built-in,vectorized)
...
- gpsObj.ENU2WGSXYZ (GPS class,vectorized)
- fcn_GPS_enu2xyz (Standalone,vectorized)
- enu2ecef (MATLAB built-in, supports one point at a time)
...
- gpsObj.ENU2WGSLLA (GPS class,vectorized)
- fcn_GPS_enu2lla (Standalone,vectorized)
- enu2lla (MATLAB built-in,vectorized)
...
*Converting the error from LLA to meters as equivalent, the results are below*
<ul>
	<li>
    <img src=".\Images\enu2lla-Difference between GPS class and MATLAB built-in-In meters equivalent.png" width="640" height="350">
    <img src=".\Images\enu2lla-Difference between Standalone and MATLAB built-in-In meters equivalent.png" width="640" height="350">
    <img src=".\Images\enu2lla-Difference between GPS class and Standalone-In meters equivalent.png" width="640" height="350">
</ul>

### ECEF to ENU
The following functions are used: 

- gpsObj.WGSXYZ2ENU (GPS class,vectorized)
- fcn_GPS_xyz2enu (Standalone,vectorized)
- ecef2enu (MATLAB built-in,supports one point at a time)
...
- fcn_GPS_xyz2lla (Standalone,vectorized)
- ecef2lla (MATLAB built-in,vectorized)
...
<ul>
	<li>
    <img src=".\Images\xyz2lla-Difference between GPS class and MATLAB built-in-In meters equivalent.png" width="640" height="350">
    <img src=".\Images\xyz2lla-Difference between Standalone and MATLAB built-in-In meters equivalent.png" width="640" height="350">
    <img src=".\Images\xyz2lla-Difference between GPS class and Standalone-In meters equivalent.png" width="640" height="350">  
</ul>
