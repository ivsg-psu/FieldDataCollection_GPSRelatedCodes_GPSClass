...
%     2023_06_28
%     -- updated installer
%     -- generalized code to account for 3 x N or N x 3 input orientations
...
if ~exist('flag_GPSClass_Folders_Initialized','var')
    this_project_folders = {'Functions','Data'};
    fcn_INTERNAL_initializeUtilities(library_name,library_folders,library_url,this_project_folders);    
    flag_GPSClass_Folders_Initialized = 1;
end
...
%% BASIC example 1 - converting LLA to ENU then back to LLA
...
%% BASIC example 2 - show that code automatically converts to columns
gps_object = GPS(); % Initiate the class object for GPS

% Use the class to convert LLA to ENU (NOTE: the LLA is transposed)
ENU_data = gps_object.WGSLLA2ENU(LLA_data(:,1)', LLA_data(:,2)', LLA_data(:,3)');
...
% Convert back to LLA (NOTE: the ENU is transposed)
LLA_data_convertedBack  =  gps_object.ENU2WGSLLA(ENU_data');
