% This script is used to test the function fcn_compareCSConversion.m;
% For more details, please see fcn_compareCSConversion.m;
close all; clear;clc; 
...
pathResult = fcn_compareCSConversion(convertMode,pathInput,referenceLLA,gpsObj);
